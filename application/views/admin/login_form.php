  ...
  transform: scale(1) translate3d(0,0,0);
        ...
        <div class="login">
            <div class="wrap">
                ...
                <!-- TERMS -->
                <div class="terms">
                    <h4 style="text-align:center;">O3M User Guide</h4>
                    
                    <img style="width:100%;" src="<?php echo base_url().'assets/images/1.jpg';?>" alt="1"></span>
                    <br/>
                    <img style="width:100%;" src="<?php echo base_url().'assets/images/2.jpg';?>" alt="2"></span>
                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="login-tab-content" class="active">
                                ...
                                <div class="help-action">
                    				...
                    				<p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="agree" href="#">User Guide</a></p>
                    			</div>
                    		</div>
                            <!-- TABS CONTENT SIGNUP -->
