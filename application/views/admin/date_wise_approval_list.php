    ...
    <tbody>
      ...
      foreach ($ul as $row) { ?>
        <tr>
          ...
          ?>
            <td style="vertical-align:middle;"><a target="_blank" href="<?php echo base_url(); ?>Dashboard/movement_bill_print/<?php echo $bn = $row['mid']; ?>">Approved By Accounts/Print</a></td>
          <?php
          }
          ?>
