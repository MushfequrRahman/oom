              ...
              <div class="col-md-12">
                <div class="box box-danger">
                      ...
                      <tbody>
                        ...
                        foreach ($ul as $row) { ?>
                          <tr>
                            ...
                            if ($row['mstatus'] == 3) {
                            ?>
                              <td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/movement_bill_acc_approved/<?php echo $bn = $row['mid']; ?>/<?php echo $row['userid']; ?>">Pending</a></td>
                            <?php
                            }
                            if ($row['mstatus'] == 4) {
                            ?>
                 ...
                 <td style="vertical-align:middle;">Approved</td>
				  ...
				  ?><?php */ ?>
                            <td style="vertical-align:middle;"><a href="<?php echo base_url(); ?>Dashboard/movement_bill_check/<?php echo $bn = $row['mid']; ?>/<?php echo $row['userid']; ?>">Details</a></td>
                          </tr>
                        <?php } ?>
                      </tbody>
                    </table>
