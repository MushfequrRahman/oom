                        ...
                        <tbody>
                          ...
                          foreach ($ul as $row) { ?>
                            <tr>
                              ...
                              <td style="vertical-align:middle;"><input type="text" class="form-control ftime timepicker" readonly name="ftime[]" value="<?php echo $row['ftime']; ?>"></td>
                              <td style="vertical-align:middle;"><input type="text" class="form-control" name="tplace[]" value="<?php echo $row['tplace']; ?>"></td>
                              <td style="vertical-align:middle;"><input type="text" class="form-control ttime timepicker" readonly name="ttime[]" value="<?php echo $row['ttime']; ?>"></td>
