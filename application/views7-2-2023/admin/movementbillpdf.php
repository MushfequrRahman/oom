  ...
  <div class="wrapper">
    <div class="top">
      ...
      <div class="text-left">
          ...
          <span>Unit:</span><span><?php echo $row['factoryid']; ?></span>
          <br />
    ...
    <div class="middle">
        ...
        <table id="tableData">
          ...
          <tbody>
            ...
            foreach ($ul as $row) { ?>
              <tr>
                <?php /*?><td style="vertical-align:middle;"><?php echo $row['mid'];?></td>
                  ...
                  <td style="vertical-align:middle;"><?php echo $row['ttime'];?></td><?php */?>
                  <?php /*?><td style="vertical-align:middle;"><?php echo $row['purpose'];?></td>
                  <td style="vertical-align:middle;"><?php echo $row['location'];?></td><?php */?>
                  <td style="vertical-align:middle; text-align: left;">Transport</td>
                  <td style="vertical-align:middle; text-align: center;"><?php echo $row['transport'];?></td>
                  
                  
                  
                  
                  
                  <?php /*?><td style="vertical-align:middle; text-align: justify;"><?php echo "Transport:&nbsp;&nbsp;".$row['transport']."<br/>"."Tiffin:&nbsp;&nbsp;".$row['tiffin']."<br/>"."Accomodation:&nbsp;&nbsp;".$row['accomodation']."<br/>"."Gift:&nbsp;&nbsp;".$row['gift']."<br/>"."Others:&nbsp;&nbsp;".$row['others']."<br/>";?></td>
                  <td style="vertical-align:middle;"><?php echo $row['ctotal'];?></td><?php */?>

              </tr>
              <tr>
              <td style="vertical-align:middle; text-align: left;">Tiffin</td>
                  <td style="vertical-align:middle; text-align: center;"><?php echo $row['tiffin'];?></td>
              </tr>
              <tr>
              <td style="vertical-align:middle; text-align: left;">Accomodation</td>
                  <td style="vertical-align:middle; text-align: center;"><?php echo $row['accomodation'];?></td>
              </tr>
              <tr>
              <td style="vertical-align:middle; text-align: left;">Gift</td>
                  <td style="vertical-align:middle; text-align: center;"><?php echo $row['gift'];?></td>
              </tr>
              <tr>
              <td style="vertical-align:middle; text-align: left;">Others</td>
                  <td style="vertical-align:middle; text-align: center;"><?php echo $row['others'];?></td>
              </tr>
          </tbody>
        <?php
              $ttotal += $row['ctotal'];
